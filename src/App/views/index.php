    ...
    <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
        ...
        <div class="hidden md:-mt-px md:flex">
            <?php foreach ($pageLinks as $pageNum => $query) : ?>
                <a href="/?<?php echo e($query); ?>" class="<?php echo $PageNum + 1 === $currentPage ? 'border-indigo-500  text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' ?> inline-flex  items-center px-4 pt-4 text-sm font-medium border-t-2">
                    <?php echo $pageNum + 1; ?>
                </a>
            <?php endforeach; ?>
